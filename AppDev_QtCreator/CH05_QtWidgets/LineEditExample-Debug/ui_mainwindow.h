...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        myLineEdit = new QLineEdit(centralwidget);
        myLineEdit->setObjectName(QString::fromUtf8("myLineEdit"));
        myLineEdit->setGeometry(QRect(10, 10, 200, 36));
        QFont font;
        ...
        myTextEdit->setGeometry(QRect(10, 60, 431, 201));
        myTextEdit->setFont(font);
        myTextEdit->setTabStopWidth(40);

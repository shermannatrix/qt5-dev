	...
	, results(0)
{
	...
	QObject::connect(ui->aboutButton,
					 &QPushButton::clicked,
					 this,
	...
	QObject::connect(ui->plusButton,
					 &QPushButton::clicked,
					 this,
					 &MainWindow::plusButtonClicked);

	QObject::connect(ui->minusButton,
					 &QPushButton::clicked,
					 this,
					 &MainWindow::minusButtonClicked);

	QObject::connect(ui->timesButton,
					 &QPushButton::clicked,
					 this,
					 &MainWindow::timesButtonClicked);

	QObject::connect(ui->divideButton,
					 &QPushButton::clicked,
					 this,
					 &MainWindow::divideButtonClicked);
}
...
void MainWindow::aboutButtonClicked()
{
	...
	messageBox.setIconPixmap(QPixmap(":/018-gamepad.png"));
